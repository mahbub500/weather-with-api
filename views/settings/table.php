...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'weather-with-api' ),
		'products'			=> __( 'Products', 'weather-with-api' ),
		'order_total'		=> __( 'Order Total', 'weather-with-api' ),
		'commission'		=> __( 'Commission', 'weather-with-api' ),
		'payment_status'	=> __( 'Payment Status', 'weather-with-api' ),
		'time'				=> __( 'Time', 'weather-with-api' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'weather-with-api' ),
		'draft'		=> __( 'Draft', 'weather-with-api' ),
	],
];
